...
public class RegistrationStepdefs {
    ...
    public void userSetDobAsDateOfBirth(String DOB) throws InterruptedException {
        ...
        String day_v = dateParts[0];
        String month_v = dateParts[1];
        String year_v=dateParts[2];
        ...
        se.selectByVisibleText(day_v);
        Thread.sleep(1000);

        month.click();
        Select se1=new Select(month);
        se1.selectByIndex(Integer.parseInt(month_v));
        Thread.sleep(1000);

        year.click();
        Select se2=new Select(year);
        se2.selectByVisibleText(year_v);
        Thread.sleep(1000);
    }
